  ...
  return (
    <AppLayout noPad>
      <div className="pt-14 px-4 flex items-center justify-between">
        ...
        <button onClick={clearChat} className="w-9 h-9 rounded-full bg-bg-surface dark:bg-bg-surface-dark flex items-center justify-center border border-slate-200 dark:border-slate-700">
        ...
        return (
          ...
          <div className="px-4 pb-4 pt-2 border-t border-slate-200 dark:border-slate-700 shrink-0">
            <div className="flex items-center gap-2 bg-bg-surface dark:bg-bg-surface-dark rounded-2xl border border-white/10 dark:border-white/5 px-4 py-3">
              ...
              />
              <button className="w-8 h-8 rounded-full bg-bg-elevated dark:bg-bg-elevated-dark flex items-center justify-center shrink-0">
